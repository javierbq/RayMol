...
def get_command_keywords(self_cmd=cmd):
    ...
    return {
        ...
        'load_msa'      : [ self_cmd.load_msa          , 0 , 0 , ''  , parsing.STRICT ],
        ...
        'msa_attach'    : [ self_cmd.msa_attach        , 0 , 0 , ''  , parsing.STRICT ],
        'msa_delete'    : [ self_cmd.msa_delete        , 0 , 0 , ''  , parsing.STRICT ],
        'msa_detach'    : [ self_cmd.msa_detach        , 0 , 0 , ''  , parsing.STRICT ],
        'msa_list'      : [ self_cmd.msa_list          , 0 , 0 , ''  , parsing.STRICT ],
        'msa_rename'    : [ self_cmd.msa_rename        , 0 , 0 , ''  , parsing.STRICT ],
        'msa_search'    : [ self_cmd.msa_search        , 0 , 0 , ''  , parsing.STRICT ],
        'msa_server'    : [ self_cmd.msa_server        , 0 , 0 , ''  , parsing.STRICT ],
        'msa_status'    : [ self_cmd.msa_status        , 0 , 0 , ''  , parsing.STRICT ],
        'msa_cancel'    : [ self_cmd.msa_cancel        , 0 , 0 , ''  , parsing.STRICT ],
        'metrics_list'  : [ self_cmd.metrics_list      , 0 , 0 , ''  , parsing.STRICT ],
        'metrics_get'   : [ self_cmd.metrics_get       , 0 , 0 , ''  , parsing.STRICT ],
        'metrics_delete': [ self_cmd.metrics_delete    , 0 , 0 , ''  , parsing.STRICT ],
        'metrics_color' : [ self_cmd.metrics_color     , 0 , 0 , ''  , parsing.STRICT ],
        'metrics_export': [ self_cmd.metrics_export    , 0 , 0 , ''  , parsing.STRICT ],
        'metrics_load'  : [ self_cmd.metrics_load      , 0 , 0 , ''  , parsing.STRICT ],
        'metrics_schema': [ self_cmd.metrics_schema    , 0 , 0 , ''  , parsing.STRICT ],
        'set_create'    : [ self_cmd.set_create        , 0 , 0 , ''  , parsing.STRICT ],
        'set_delete'    : [ self_cmd.set_delete        , 0 , 0 , ''  , parsing.STRICT ],
        'set_rename'    : [ self_cmd.set_rename        , 0 , 0 , ''  , parsing.STRICT ],
        'set_list'      : [ self_cmd.set_list          , 0 , 0 , ''  , parsing.STRICT ],
        'set_info'      : [ self_cmd.set_info          , 0 , 0 , ''  , parsing.STRICT ],
        'set_schema'    : [ self_cmd.set_schema        , 0 , 0 , ''  , parsing.STRICT ],
        'set_add'       : [ self_cmd.set_add           , 0 , 0 , ''  , parsing.STRICT ],
        'set_remove'    : [ self_cmd.set_remove        , 0 , 0 , ''  , parsing.STRICT ],
        'set_get'       : [ self_cmd.set_get           , 0 , 0 , ''  , parsing.STRICT ],
        'set_set'       : [ self_cmd.set_set           , 0 , 0 , ''  , parsing.STRICT ],
        'set_star'      : [ self_cmd.set_star          , 0 , 0 , ''  , parsing.STRICT ],
        'set_reject'    : [ self_cmd.set_reject        , 0 , 0 , ''  , parsing.STRICT ],
        'set_pin'       : [ self_cmd.set_pin           , 0 , 0 , ''  , parsing.STRICT ],
        'set_tag'       : [ self_cmd.set_tag           , 0 , 0 , ''  , parsing.STRICT ],
        'set_filter'    : [ self_cmd.set_filter        , 0 , 0 , ''  , parsing.LITERAL1 ],
        'set_sort'      : [ self_cmd.set_sort          , 0 , 0 , ''  , parsing.STRICT ],
        'set_view_save' : [ self_cmd.set_view_save     , 0 , 0 , ''  , parsing.LITERAL2 ],
        ...
        'set_export'    : [ self_cmd.set_export        , 0 , 0 , ''  , parsing.STRICT ],
        'set_import'    : [ self_cmd.set_import        , 0 , 0 , ''  , parsing.STRICT ],
        ...
        'design_result'  : [ self_cmd.design_result   , 0 , 0 , ''  , parsing.STRICT ],
        'design_weights' : [ self_cmd.design_weights  , 0 , 0 , ''  , parsing.STRICT ],
        'design_weights_cancel': [ self_cmd.design_weights_cancel , 0 , 0 , ''  , parsing.STRICT ],
        'design_sequences': [ self_cmd.design_sequences , 0 , 0 , ''  , parsing.STRICT ],
        'design_sequences_status': [ self_cmd.design_sequences_status , 0 , 0 , ''  , parsing.STRICT ],
        'design_sequences_cancel': [ self_cmd.design_sequences_cancel , 0 , 0 , ''  , parsing.STRICT ],
