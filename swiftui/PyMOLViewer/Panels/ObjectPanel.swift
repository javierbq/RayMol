    ...
    static let specs: [String: RepSpec] = [
        ...
        "surface": RepSpec(rep: "surface", display: "Surface",
            colorSetting: "surface_color", defaultColor: -1, properties: [
                ...
                RepProperty(setting: "surface_clip_front", label: "Clip front", kind: .slider, min: 0, max: 40, step: 0.5, decimals: 1),
                RepProperty(setting: "surface_clip_back", label: "Clip back", kind: .slider, min: 0, max: 40, step: 0.5, decimals: 1),
